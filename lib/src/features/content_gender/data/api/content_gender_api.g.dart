...
part of 'content_gender_api.dart';
...
class _ContentGenderApi implements ContentGenderApi {
  _ContentGenderApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<DataResponse<GenreModel>> addGenres(GenreModel? body) async {
    final _extra = <String, dynamic>{};
